...
NativeCollection.prototype.initializeUnorderedBulkOp = function() {
  var collection = this.conn.db.collection(this.name);
  return collection.initializeUnorderedBulkOp.apply(collection, arguments);
};
